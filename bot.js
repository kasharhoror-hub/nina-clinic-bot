...
// This replaces the old 'new Map()' and fixes session loss.
bot.use(session({
...
bot.on('text', async (ctx) => {
  ...
  const session = ctx.session; // Use ctx.session directly
